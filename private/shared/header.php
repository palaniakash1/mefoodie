...
<header class="bg-white shadow-md flex flex-col md:flex-row items-center justify-between px-6 py-2 sticky top-0 z-50 home-header sm-w-full">
    <!-- Logo -->
    ...
    <!-- Search Bar -->
    <div class="relative w-full md:w-1/2 search-container-parent" >

...
<header class="bg-white shadow-md flex flex-col md:flex-row items-center justify-between px-6 py-2 sticky top-0 z-50 w-full home-header">
    <div class="flex items-start space-x-2 mb-2 md:mb-0">
        <a href="<?php echo $base_url; ?>/index.php">
            <h1 class="text-2xl font-bold text-red-600 tracking-tight">MeFoodie</h1>
        </a>
    </div>

    <button id="openPopupBtn" class="text-sm font-medium text-red-600 hover:text-red-800 transition reg-btn">
